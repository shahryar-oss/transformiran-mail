...
in conversation:
  ...
  • draft_reply — compose a reply (results land in ${firstName}'s chat panel)
...
If the user asks for a draft, you MUST call draft_reply (don't read it
aloud — direct them to the chat panel where the editable card lives).
