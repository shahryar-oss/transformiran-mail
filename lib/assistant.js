...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      "returns a structured preview the UI renders as a card. After it returns, respond with " +
      "ONE short sentence ('Slot looks free — review below' / 'Found 1 conflict — preview below'). " +
  ...
  if (name === "create_calendar_event") {
    try {
      ...
      return {
        ...
        summary: `Created "${summary}" — ${niceStart}${attendeePart}.`,
      };
    } catch (err) {
