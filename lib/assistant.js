...
const TOOLS = [
  {
    ...
    description:
      ...
      "Use this when the user says 'clean my inbox', 'organize my inbox', 'help me declutter', 'reduce my inbox', or similar requests for bulk inbox management. " +
      ...
      "After calling this tool, respond with a brief sentence like 'Here's what I found — review each batch and act on what you want.'",
    input_schema: {
      type: "object",
      properties: {
        scope: {
...
module.exports = { chat, draftReply, buildContext, buildSystemPrompt, buildCleanupProposal, CHAT_MODEL, MODELS, resolveModel };
