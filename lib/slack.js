...
async function searchTranscriptsLocal(terms, lim) {
...
async function searchTranscriptsByChannels(channelIds, terms, lim) {
    ...
    try {
      ...
      try {
        ...
        const [byTerm, byChannel] = await Promise.all([
          searchTranscriptsLocal(localTerms, lim),
          searchTranscriptsByChannels(channelIds, localTerms, lim),
        ]);
        const seenV = new Set();
